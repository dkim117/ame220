...
var moveBoxRight= function(n, easing, duration)
{
  ...
  if(jq){
    ...
    if(n >= 5) return;
    $(id).css({"background-color" : ec, "margin-left":pageWidth-boxWidth + "px", "transition-duration": duration +"ms", "transition-timing-function" : easing});
...
var moveBoxLeft= function(n, easing, duration)
{
  ...
  if(jq){
    ...
    if(n >= 5) return;   
   $(id).css({"background-color" : ec, "margin-left" : "0px", "transition-duration": duration +"ms", "transition-timing-function" : easing});
